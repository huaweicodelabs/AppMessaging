...
let AGCAppMessagingLog = AGCAppMessagingLogger(version: "1.2.0", service: "CordovaAppMessaging")

/// Custom AGCAppMessagingLogger Class to listen api log events from Cordova Side.
final class AGCAppMessagingLogger {
  ...
  private var prefix: String = "AGCAppMessagingLogger"
